...
zone_orientation_dir = 90 + ((180*(make_zone_x - current_world_x)) / (pi * WORLD_RADIUS)) // get direction pointing towards zone center
zone_center_dist = WORLD_RADIUS + ( make_zone_y - current_world_y)
...
m_block_x = lengthdir_x(zone_center_dist,zone_orientation_dir) + lengthdir_x(point_distance(0,0,make_block_temp_x,make_block_temp_y),make_block_dir) + world_center_x
m_block_y = lengthdir_y(zone_center_dist,zone_orientation_dir) + lengthdir_y(point_distance(0,0,make_block_temp_x,make_block_temp_y),make_block_dir) + world_center_y
