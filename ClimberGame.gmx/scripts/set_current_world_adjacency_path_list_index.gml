...
while(abs(((point_direction(obj_world.x,obj_world.y,obj_player.x,obj_player.y) + 90) % 360 )- (point_direction(obj_world.x,obj_world.y,ds_list_find_value(temp_list_id,0),ds_list_find_value(temp_list_id,1)) + 90 % 360)) > .001
        &&
        (point_direction(obj_world.x,obj_world.y,obj_player.x,obj_player.y) + 90) % 360 < (point_direction(obj_world.x,obj_world.y,ds_list_find_value(temp_list_id,0),ds_list_find_value(temp_list_id,1)) + 90 % 360))
{
